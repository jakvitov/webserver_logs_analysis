...
def createAndSendEmail(input_logs, output_logs):
    ...
    error_info = getBasicErrorsDataAndFillTemplate(error_info, input_logs)
    error_info = fillInfoFromAccessLog(error_info, input_logs)
    ...
    # We move the log files to another directory and create them with according date of analysis creation
    moveLogFiles(input_logs, output_logs)